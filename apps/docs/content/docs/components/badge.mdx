...
```html preview
<!-- START https://startingpointui.com/examples/docs/badge/1 -->
<span class="badge">Badge</span>
<!-- END https://startingpointui.com/examples/docs/badge/1 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/badge/2 -->
<span class="badge">Default</span>
<span class="badge badge-secondary">Secondary</span>
<span class="badge badge-destructive">Destructive</span>
<span class="badge badge-outline">Outline</span>
<!-- END https://startingpointui.com/examples/docs/badge/2 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/badge/3 -->
<span class="badge">
...
<!-- END https://startingpointui.com/examples/docs/badge/3 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/badge/4 -->
...
<!-- END https://startingpointui.com/examples/docs/badge/4 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/badge/5 -->
...
<!-- END https://startingpointui.com/examples/docs/badge/5 -->
```

You can also use solid colors for higher contrast.

```html preview
<!-- START https://startingpointui.com/examples/docs/badge/6 -->
...
<!-- END https://startingpointui.com/examples/docs/badge/6 -->
```
