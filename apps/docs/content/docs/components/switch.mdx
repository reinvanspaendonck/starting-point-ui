...
```html preview
<!-- START https://startingpointui.com/examples/docs/switch/1 -->
<input type="checkbox" role="switch" class="switch" />
<!-- END https://startingpointui.com/examples/docs/switch/1 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/switch/2 -->
...
<!-- END https://startingpointui.com/examples/docs/switch/2 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/switch/3 -->
...
<!-- END https://startingpointui.com/examples/docs/switch/3 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/switch/4 -->
<div class="w-full max-w-xs">
  <div class="grid gap-5">
    <div class="flex items-start justify-between gap-4">
      <div class="grid gap-2">
...
<!-- END https://startingpointui.com/examples/docs/switch/4 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/switch/5 -->
<div class="flex items-center gap-3">
  <input
    type="checkbox"
    role="switch"
...
<!-- END https://startingpointui.com/examples/docs/switch/5 -->
```
