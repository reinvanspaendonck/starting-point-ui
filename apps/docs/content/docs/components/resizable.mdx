...
```html preview
<!-- START https://startingpointui.com/examples/docs/resizable/1 -->
...
<!-- END https://startingpointui.com/examples/docs/resizable/1 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/resizable/2 -->
<div
...
<!-- END https://startingpointui.com/examples/docs/resizable/2 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/resizable/3 -->
<div class="resizable rounded-lg border h-48 overflow-hidden">
  <div
    class="resizable-panel flex items-center justify-center bg-muted/50"
    style="flex-basis: 25%"
...
<!-- END https://startingpointui.com/examples/docs/resizable/3 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/resizable/4 -->
<div class="resizable rounded-lg border h-48 overflow-hidden">
  <div
    class="resizable-panel flex items-center justify-center bg-muted/50"
    style="flex-basis: 50%"
...
<!-- END https://startingpointui.com/examples/docs/resizable/4 -->
```
...
```html preview
<!-- START https://startingpointui.com/examples/docs/resizable/5 -->
<div class="resizable rounded-lg border h-48 overflow-hidden">
  <div
...
<!-- END https://startingpointui.com/examples/docs/resizable/5 -->
```
